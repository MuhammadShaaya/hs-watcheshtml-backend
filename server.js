...
// Newer versions of the MongoDB driver return the updated document directly
// from findOneAndUpdate; older versions wrap it as { value: doc }. Handle
// both so this keeps working regardless of which driver version gets
// installed.
function unwrapFindResult(result) {
...
async function nextId(field) {
  ...
  const doc = unwrapFindResult(result);
  return doc[field];
}
...
app.put("/api/admin/products/:id", requireAdmin, async (req, res) => {
  ...
  const updated = unwrapFindResult(result);
